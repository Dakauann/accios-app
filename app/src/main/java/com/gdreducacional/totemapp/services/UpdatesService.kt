...
import com.gdreducacional.totemapp.services.RequestHeaders.applyApkDownloadHeaders
import com.gdreducacional.totemapp.services.RequestHeaders.applyJsonHeaders
...
class UpdatesService : Service() {
	...
	companion object {
		...
		private const val ACTION_FORCE_CHECK = "com.gdreducacional.totemapp.action.FORCE_UPDATE_CHECK"
		private const val INSTALL_STATUS_ACTION = "com.gdreducacional.totemapp.action.INSTALL_STATUS"
